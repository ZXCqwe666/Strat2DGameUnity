	...
	public class RuleTile : TileBase
	{
		...
		private bool RuleBroken(TilingRule rule, int index, TileBase tile)
		{
			return (rule.m_Neighbors[index] == TilingRule.Neighbor.This && tile != this)
				|| (rule.m_Neighbors[index] == TilingRule.Neighbor.Empty && (tile == this)) //(rule.m_Neighbors[index] == TilingRule.Neighbor.NotThis && (tile == this || tile == null))
				|| (rule.m_Neighbors[index] == TilingRule.Neighbor.NotThis && (tile == null))
				;
		}
